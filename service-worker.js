...
// (the 52de6f7 placeholder → short git SHA). Every deploy therefore gets a unique
...
const CACHE_VERSION='loto-shell-auto-20260920-tlnqm3';
const SHELL_CACHE=`${CACHE_VERSION}-static`;
const DATA_CACHE=`${CACHE_VERSION}-data`;
const CORE_PRECACHE=[
  './','./index.html','./commercial-config.js',
  './i18n-catalog.js','./lang-detect.js','./i18n-runtime.js','./commercial-runtime.js','./pwa-runtime.js','./native-loader.js',
