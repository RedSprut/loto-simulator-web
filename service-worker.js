...
// (the a03b07b placeholder → short git SHA). Every deploy therefore gets a unique
...
const CACHE_VERSION='loto-shell-a03b07b';
...
const PUSH_DESTINATIONS={draw_result:'analytics',jackpot_updated:'simulator',saved_ticket_result:'check',deadline_reminder:'simulator'};
...
self.addEventListener('push',event=>{
  ...
  const options={
    ...
    data:{notificationType:type,lotteryId:payload.lotteryId||'',drawId:payload.drawId||payload.date||'',destination:destination},
  };
